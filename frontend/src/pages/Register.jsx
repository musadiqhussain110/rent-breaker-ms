...
export default function Register({ onRegistered }) {
  ...
  async function submit(e) {
    ...
    try {
      // 1) Register (backend forces role=customer)
      ...
      <div className="relative mx-auto w-full max-w-md">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-slate-700 dark:text-slate-300">
            {greeting}. Create your customer account.
          </p>
          ...
          <CardContent className="p-6 sm:p-7">
            <form onSubmit={submit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-slate-800 dark:text-slate-200">Name (optional)</Label>
...
<Button type="submit" className="w-full" disabled={loading}>
  {loading ? "Creating..." : "Create account"}
              ...
              <p className="pt-1 text-center text-xs text-slate-600 dark:text-slate-400">
                If you can’t see “My Rentals”, ask staff/admin to link your login in Customers.
              </p>
            </form>
          </CardContent>
        </Card>
